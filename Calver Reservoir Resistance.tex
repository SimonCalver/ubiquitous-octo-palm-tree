...
This reservoir can potentially harbour virus indefinitely while the person is being treated~\cite{siliciano2003,crooks2015}, for  it to later re-emerge when treatment stops (ref). The appearance of the reservoir   only takes a few days~\cite{sompayrac2011}. %but will persist for a long time due to low activation rate \cite{finzi1999} (REF) so even on ART the virus can remain in the body essentially indefinitely (REF, same?)
